...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0 h6">{{translate('Our SMS Credential')}}</h5>
                </div>
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('update_credentials') }}" method="POST">
                        <input type="hidden" name="otp_method" value="msegat">
                        ...
                        <div class="form-group row">
                            <input type="hidden" name="types[]" value="oursms_USERNAME">
                            <div class="col-lg-3">
                                <label class="col-from-label">{{translate('Our Sms User Name')}}</label>
                            </div>
                            <div class="col-lg-6">
                                <input type="text" class="form-control" name="oursms_USERNAME" value="{{  env('oursms_USERNAME') }}" placeholder="Our Sms_USERNAME" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <input type="hidden" name="types[]" value="ouersms_API_KEY">
                            <div class="col-lg-3">
                                <label class="col-from-label">{{translate('ouersms_API_KEY')}}</label>
                            </div>
                            <div class="col-lg-6">
                                <input type="text" class="form-control" name="ouersms_API_KEY" value="{{  env('ouersms_API_KEY') }}" placeholder="Ouersms_API_KEY" required>
                            </div>
                        </div>
